...
export default function ContactForm({ labels }: Props) {
  ...
  const inputClass = "w-full bg-navy-light border border-border rounded px-3 py-2 text-text-primary text-sm focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors placeholder:text-text-secondary/50";
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
      ...
      <button type="submit" className="bg-accent text-white font-semibold px-6 py-3 rounded hover:bg-accent/90 transition-colors flex items-center gap-2 justify-center">
